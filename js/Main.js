...
mapLayers.push(L.geoJson.ajax("http://localhost:8080/geoserver/activesReestr/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=activesReestr%3AEducationReesrt-polygon&maxFeatures=50&outputFormat=application%2Fjson",
                                        {
...
mapLayers.push(L.geoJson.ajax("http://localhost:8080/geoserver/activesReestr/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=activesReestr%3AFactoryReestr-polygon&maxFeatures=50&outputFormat=application%2Fjson",
                                        {
                                            onEachFeature: onEachFeature,
                                            style: function (feature) {
                                                return {color: '#AA0551'};
...
mapLayers.push(L.geoJson.ajax("http://localhost:8080/geoserver/activesReestr/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=activesReestr%3ANonLivingBuildsReestr-polygon&maxFeatures=50&outputFormat=application%2Fjson",
                                        {
                                            onEachFeature: onEachFeature,
                                            style: function (feature) {
                                                return {color: '#3388ff'};
