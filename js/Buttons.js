...
function zoomTo(feature, layerNum, pointNum)
{
  ...
  {
    map.flyTo(L.latLng(feature.geometry.coordinates));
  }
  else
  {
    var tempCenter = getCentroid(feature.geometry.coordinates[0][0]);
    var tempRotCenter = [tempCenter[1], tempCenter[0]];

    map.flyTo(L.latLng(tempRotCenter));
  }
